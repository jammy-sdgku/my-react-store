...
<span key={category.name} style={{ margin: '0.5rem', padding:
'0.5rem', background: 'white', borderRadius: '4px', display: 'inline-block'
}}>
...
<div key={product.id} style={{ background: 'white', padding:
'1rem', borderRadius: '8px' }}>
<h4>{product.title}</h4>
<p>${product.price}</p>
